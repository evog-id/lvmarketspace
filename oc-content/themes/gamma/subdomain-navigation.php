...
<body id="subdomain" class="subdomain-navigation sd-<?php echo osc_subdomain_type(); ?> <?php if(in_array(osc_subdomain_type(), array('country', 'language'))) { ?>sd-with-icon<?php } ?> has-footer">
  ...
  <section class="container">
    <div class="box">
      ...
      <div class="wrapper">
        <div class="m25"><?php _e('Join our community to buy and sell from each other everyday around the world.', 'gamma'); ?></div>
        <div><strong><?php _e('Please select preferred site:', 'gamma'); ?></strong></div>
