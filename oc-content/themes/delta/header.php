...
<header>
  <div class="inside">
    ...
    <div class="relative2">
      ...
      <div class="left isDesktop isTablet">
         <a class="publish btn mbBg2 isDesktop isTablet" href="<?php echo del_logo(); ?>">
          <span class="mbCl2">
          ...
          <div class="link-box">
            ...
            <div class="user-menu" style="display:none;">
              <div class="ins">
                ...
                <a href="<?php echo osc_route_url('osp-cart'); ?>"><?php _e('My card', 'delta'); ?></a>
