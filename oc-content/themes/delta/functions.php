<?php
define('DELTA_THEME_VERSION', '1.5.5');
...
function del_logo($image_only = false) {
  ...
  if(del_param('default_logo') == 1 && file_exists(WebThemes::newInstance()->getCurrentThemePath() . 'images/logo-default.jpg')) {
    $src = osc_current_web_theme_url('images/logo-default.jpg');
